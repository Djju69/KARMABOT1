...
async def on_help(message: Message):
    ...
    if not await ensure_policy_accepted(message):
        return
    # Определяем ссылку для регистрации партнёра: PARTNER_SIGNUP_URL -> WEBAPP_QR_URL/cabinet -> TG admin
    ...
    html = (
        ...
        "<b>🧑‍💼 Стать партнёром</b>\n\n"
        "Присоединяйтесь к нам! Разместите свою компанию в каталоге и начните привлекать новых клиентов.\n\n"
        f"• <b>Добавить карточку:</b> <a href=\"{partner_url}\">перейти к регистрации</a>\n\n"
        "<b>Документы</b>:\n"
