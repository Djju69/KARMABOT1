    ...
    try:
        ...
        async with Bot(
            ...
            if DISABLE_WEBHOOK:
                ...
                # ПРИНУДИТЕЛЬНО используем RAILWAY_STATIC_URL для правильного домена
                ...
                full_webhook_url = f"{RAILWAY_URL}/webhook"
                    ...
                    try:
                        ...
                        def run_async_in_thread():
                            ...
                            try:
                                ...
                                try:
                                    # Создаем новый bot instance с новой сессией для этого потока
                                    # Это предотвращает конфликты сессий между потоками
                                    import aiogram
